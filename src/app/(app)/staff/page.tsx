...
export default async function StaffPage() {
  ...
  return (
    <>
      <PageHeader
        title="Staff"
        description="Everyone with an account in this organization, and how many active patients they are currently on the care team for. Adding or removing an account is not built yet - ask an administrator."
      />
        ...
        <DataTable
          ...
          empty={
            <EmptyState icon={Users} title="No staff accounts yet">
              Accounts are created by seeding or by an administrator.
            </EmptyState>
          }
        />
      </Section>
